        ...
        <div class="user-details">
            <div class="pull-left">
                <div class="user-img sidebar-profile-img">
                    <img src="{{ $my_info->user_image ? $my_info->user_image : asset('back-office/images/default_image.png') }}" alt="User Image">
                </div>
            </div>
            <div class="user-info">
                <div class="dropdown">
        ...
        @if ($role == 'Administrator')
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li><a href="{{ route('users.all') }}" class="waves-effect"><i class="ti-user"></i><span>Users </span> </a> </li>
                    ...
                    <li><a href="{{ route('admin.investments') }}" class="waves-effect {{ request()->is('investments') ? 'active' : '' }}"><i class="ti-shopping-cart"></i> <span> Investments</span> </a> </li>
                    <li class="has_sub">
        ...
        @else
            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li><a href="{{ route('user.my-investments') }}" class="waves-effect {{ request()->is('my-investments') ? 'active' : '' }}"><i class="ti-shopping-cart"></i> <span> My Investments</span> </a> </li>
                    <li><a href="{{ route('user.profile') }}" class="waves-effect {{ request()->is('my-profile') ? 'active' : '' }}"><i class="ti-id-badge"></i> <span> Profile Settings</span> </a> </li>
                </ul>
                <div class="clearfix"></div>
            </div>
