                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="asset_name" name="asset_name" placeholder="Asset Name" required value="{{ $asset->asset_name }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="asset_description">Asset Description</label>
                                            <div class="summernote" id="asset_description" name="asset_description">{!! $asset->asset_description !!}</div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" min="0" id="asset_price" name="asset_price" class="form-control" placeholder="0.00" required value="{{ $asset->asset_price }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" min="0" id="asset_quantity" name="asset_quantity" class="form-control" placeholder="0" required value="{{ $asset->asset_quantity }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="post_type" id="post_type" class="form-control">
                                                <option value="publish" {{ $asset->post_type == 'publish' ? 'selected' : '' }}>Published</option>
                                                <option value="draft" {{ $asset->post_type == 'draft' ? 'selected' : '' }}>Draft</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <button class="btn btn-inverse d-block full-width has-spinner" type="button" onclick="submitAsset(this, 'assetForm')">Update Asset</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
