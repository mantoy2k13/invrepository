                    ...
                    <div class="col-lg-12"> 
                        ...
                        <div class="tab-content"> 
                            <div class="tab-pane active" id="profile-update"> 
                                {{-- Edit Profile --}}
                                <form action="{{ route('user.update-profile') }}" data-parsley-validate method="POST" id="updateProfileForm">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="profile-image-upload">
                                                    <div class="uploaded-files-wrapper img-responsive">
                                                        ...
                                                        <input id="uploadFiles" type="file" accept=".gif, .png, .jpg, .jpeg" onchange="previewImage(this, '.profile-image-upload', 'profile_image')">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <button class="btn btn-inverse has-spinner" type="button" onclick="updateProfileAccount(this, 'updateProfileForm', 'prof-err-msg')">Update Profile</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div class="tab-pane" id="account-update">
                                ...
                                <form action="{{ route('user.update-account') }}" data-parsley-validate method="POST" id="updateAccountForm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <button class="btn btn-inverse has-spinner" type="button" onclick="updateProfileAccount(this, 'updateAccountForm', 'acc-error-msg')">Update Account</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
